...
!define MADDOG_DEFAULT_INSTALLDIR "$LOCALAPPDATA\Programs\${INFO_PRODUCTNAME}"
...
InstallDir "${MADDOG_DEFAULT_INSTALLDIR}" # Per-user install location (no admin rights required).
...
!macro maddog.deleteUninstaller
...
fallback:
   StrCpy $INSTDIR "${MADDOG_DEFAULT_INSTALLDIR}"
done:
FunctionEnd
...
Section
    ...
    !insertmacro maddog.writeUninstaller
SectionEnd
...
Section "uninstall"
    ...
    !insertmacro maddog.deleteUninstaller
SectionEnd
