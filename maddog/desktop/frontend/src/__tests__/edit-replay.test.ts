...
eq(
  replaySubmitText("hidden session context\nvisible prompt @.maddog/attachments/a.png", "visible prompt @[a.png](.maddog/attachments/a.png)", "updated prompt @[a.png](.maddog/attachments/a.png)", "updated prompt @.maddog/attachments/a.png"),
  "hidden session context\nupdated prompt @.maddog/attachments/a.png",
