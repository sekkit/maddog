...

{
  ...
  installBridgeApp({
    SavePastedImage: async () => ".maddog/attachments/mock.png",
    AttachmentDataURL: async () => "data:image/png;base64,iVBORw0KGgo=",
  });
  ...
  ok(sent[0]?.submit?.includes("@.maddog/attachments/mock.png") === true, "submitted text retains the local image attachment ref");
