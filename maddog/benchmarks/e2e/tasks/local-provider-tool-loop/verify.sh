...
output = Path("fixture-output.txt")
assert output.exists(), "fixture-output.txt missing"
assert output.read_text(encoding="utf-8").strip() == "MADDOG_LOCAL_FIXTURE_TOOL_LOOP_OK"
