...
func TestDisplayLineForImageRefsCollapsesMaddogAttachmentRefs(t *testing.T) {
	got := displayLineForImageRefs("describe @.maddog/attachments/clipboard-20260601-010203.000001.png")
	want := "describe [image1]"
	if got != want {
		t.Fatalf("displayLineForImageRefs = %q, want %q", got, want)
	}
}
