// Package netclient builds HTTP clients that share Maddog's user-facing proxy
...
// NewHTTPClient returns an HTTP client with Maddog proxy settings applied.
