...
type Tool struct {
	...
	Partial bool
	// Refreshed marks a repeated full dispatch whose preview was recomputed after
	// an earlier writer changed disk. Upsert-capable frontends replace by ID;
	// append-only sinks ignore it.
	Refreshed bool
