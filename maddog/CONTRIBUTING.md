# Contributing to Maddog

Thank you for your interest in contributing to Maddog! This guide covers
...
```bash
git clone https://github.com/sekkit/maddog.git
cd maddog
go build ./cmd/maddog    # builds the CLI binary
...
| `internal/memory` | MADDOG.md hierarchy + auto-memory |
...
Maddog treats high prompt-cache hit rate as product behavior. Changes that
