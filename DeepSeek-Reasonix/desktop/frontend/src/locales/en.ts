...
export const en = {
  ...
  "status.routeIdle": "route default",
  "status.routeIdleTitle": "No frontier route change this session",
  "status.routeActive": "route frontier",
  "status.skillIdle": "skill idle",
  "status.skillIdleTitle": "No runtime skill orchestration event yet",
  "status.skillActive": "skill active",
