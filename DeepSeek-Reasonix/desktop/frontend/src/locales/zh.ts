...
export const zh: Record<DictKey, string> = {
  ...
  "status.routeIdle": "路由 默认",
  "status.routeIdleTitle": "本会话还没有 frontier 路由切换",
  "status.routeActive": "路由 frontier",
  "status.skillIdle": "skill 空闲",
  "status.skillIdleTitle": "尚无运行时 skill 编排事件",
  "status.skillActive": "skill 活跃",
