...
const FONT_FAMILY_KEY = "maddog-font-family";
const CUSTOM_FONT_KEY = "maddog-font-family-custom";
const MONO_FONT_FAMILY_KEY = "maddog-mono-font-family";
const CUSTOM_MONO_FONT_KEY = "maddog-mono-font-family-custom";
