...
auto-read or auto-import legacy Reasonix configuration such as `~/.reasonix`,
`~/.config/reasonix`, `.reasonix`, or `reasonix.toml`. This keeps Maddog and an
installed DeepSeek Reasonix from changing each other's configuration or runtime
