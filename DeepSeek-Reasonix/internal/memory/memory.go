...
type Set struct {
	Docs    []Source // MADDOG.md / AGENTS.md / CLAUDE.md, ascending precedence
...
// (MADDOG.md / AGENTS.md / CLAUDE.md, in that order); when none exists it
// creates the Maddog default (MADDOG.md / MADDOG.local.md). ScopeUser →
