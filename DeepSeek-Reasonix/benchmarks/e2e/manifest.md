...
- `filesystem`: `compaction`, `fix-add-bug`, `fizzbuzz`, `palindrome`, `project-config-isolation`, `project-skill-invocation`, `provider-auth-frontier-profile`, `readiness-evidence-gate`, `subagent-delegation`
